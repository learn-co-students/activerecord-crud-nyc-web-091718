...
def can_be_instantiated_and_then_saved
  movie = Movie.new(title: "Lord", release_date: 6, director: "JRR", lead: "Hobbit", in_theaters: false)
...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.all.where("release_date > 2002").reverse_order
end
...
def can_update_using_update_method
  ...
  mov = Movie.all.find_by(title: "Wat?")
...
def can_destroy_a_single_item
  ...
  mov_id = Movie.all.find_by(title:"That One Where the Guy Kicks Another Guy Once").id
  Movie.delete(mov_id)
end
